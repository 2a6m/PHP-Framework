...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ArtisteRepository' => function () {
    return ($this->privates['App\Repository\ArtisteRepository'] ?? $this->load('getArtisteRepositoryService.php'));
}, 'App\\Repository\\MorceauRepository' => function () {
    return ($this->privates['App\Repository\MorceauRepository'] ?? $this->load('getMorceauRepositoryService.php'));
}))));
