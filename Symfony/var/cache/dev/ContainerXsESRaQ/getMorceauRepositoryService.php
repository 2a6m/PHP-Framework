...
// Returns the private 'App\Repository\MorceauRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MorceauRepository.php';

return $this->privates['App\Repository\MorceauRepository'] = new \App\Repository\MorceauRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
