...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ArtisteType' => function () {
    return ($this->privates['App\Form\ArtisteType'] ?? $this->privates['App\Form\ArtisteType'] = new \App\Form\ArtisteType());
}, 'App\\Form\\MorceauType' => function () {
    return ($this->privates['App\Form\MorceauType'] ?? $this->privates['App\Form\MorceauType'] = new \App\Form\MorceauType());
